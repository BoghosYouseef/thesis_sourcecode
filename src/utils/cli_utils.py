...
from .path_funcs import get_relative_saved_models_folder_path, get_abs_path

def get_list_of_available_models():

    saved_models = filter(lambda x: x!="__init__.py",os.listdir(get_relative_saved_models_folder_path()))
